...
export function DocumentVerification({ documents }: DocumentVerificationProps) {
  ...
  const handleVerification = async () => {
    ...
    const foundDocument = documents.find(
      doc => doc.verificationCode === verificationCode.trim()
    );
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                      ...
                      <div className="bg-white p-4 rounded-lg">
                        ...
                        <p className="text-gray-900 font-medium">
                          {new Date(searchResult.uploadDate).toLocaleDateString()}
                        </p>
                      </div>
                      ...
                      <div className="bg-white p-4 rounded-lg">
                        ...
                        <p className="text-gray-900 font-medium">${searchResult.totalCost}.00</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 bg-white p-4 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-mono text-gray-900">{searchResult.verificationCode}</span>
                        </div>
                        <div className="flex justify-between">
