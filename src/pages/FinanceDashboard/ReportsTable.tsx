          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full px-4 py-2 bg-tfe-blue-600 text-white rounded-md hover:bg-tfe-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tfe-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
