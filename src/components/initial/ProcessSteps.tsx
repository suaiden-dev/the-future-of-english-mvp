...
const ProcessSteps = () => {
  ...
  const steps = [
    {
      step: 1,
      title: t("processes.initial.step1.title"),
      price: t("processes.initial.step1.price"),
      description: t("processes.initial.step1.description"),
      items: t("processes.initial.step1.items", { returnObjects: true }) as string[],
      colorClass: "bg-coral",
    ...
    },
    {
      ...
      description: t("processes.shared.applicationFee.description"),
    ...
    },
    {
      ...
      description: t("processes.shared.placementFee.description"),
    ...
    },
    {
      ...
      price: t("processes.shared.legalFees.price") || "$1.800",
      description: t("processes.shared.legalFees.description"),
      items: t("processes.shared.legalFees.items", { returnObjects: true }) as string[],
